import { basavaEnglishIntro } from "./content"
...
const stats = [
  ...
  // async function  getBasavaDetails() {
  //   const response = await fetch("/api/getBasavaDetail");
  //   return response;
  // }
 

  export default async function  Introduction() {
    // const basava: string[] = await getBasavaDetails();
    return (
