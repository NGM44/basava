...
import { basavaHindiIntro, basavaKannadaIntro } from "../component/content";
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <KannadaBanner />
      <div className="">
        <Link className="text-white   px-8" href={"/kannada"}>
          Kannada
        </Link>
        <Link className="text-slate-500 px-8" href={"/"}>
          English
        </Link>
      </div>
                ...
                <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                  ...
                  <figure className="relative isolate">
                    ...
                    <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                      <strong className="font-semibold text-white">ಬಸವ</strong>{" "}
                    </figcaption>
                  </figure>
                </div>
              ...
              <div>
                <div className="text-base leading-7 text-gray-700 lg:max-w-lg text-balance">
                  ...
                  <div className="max-w-xl text-gray-500">
                    {basavaKannadaIntro.map((element, index) => (
